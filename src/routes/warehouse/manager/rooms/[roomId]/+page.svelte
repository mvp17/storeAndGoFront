...
<Card style="margin-top:15px;">
  ...
  {#if room.room_status === 1}
    <div class="grid gap-3 md:grid-cols-2">
      ...
      <Button on:click={() => { open = true; newTemp = room.temp }}>Update Temperature</Button>
    </div>
  {/if}
</Card>
...
<Modal title="Update temperature" bind:open={open} size="xs" autoclose class="w-full">
...
<style>
  ...
  h3 {color: #17B169; font-weight: bold;}
</style>
